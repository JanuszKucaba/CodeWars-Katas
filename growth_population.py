...
1070 + 1070 * 0.02 + 50
=> 1141 inhabitants (** number of inhabitants is an integer **)
...
# long version
def nb_year(p0, percent, aug, p=1200):
    """
    Input:
        p0 - population at the beginnning of a year
        percent - percent increase of population per year
        aug - amount of come or leave inhabitants each year
        p - population to surpass

    Output: entire years needed to get a population greater or equal to p.
    """
    n = 0
    while True:
...
# short version
def nb_year_2(p0, percent, aug, p, n=0):
    """
    Input:
        p0 - population at the beginnning of a year
        percent - percent increase of population per year
    ...
    """
    if p0 < p:
        return nb_year_2((p0 + int(p0 * percent/100) + aug), percent, aug, p, n+1)
    return n
...
if __name__ == '__main__':
    ...
    print()
    print(nb_year_2(1500, 5, 100, 5000))
    print(nb_year_2(1500000, 2.5, 10000, 2000000))
    print(nb_year_2(1500000, 0.25, 1000, 2000000))
