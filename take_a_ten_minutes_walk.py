...
def is_valid_walk(walk):
    """
    Input: list of directions to walk: 'n', 's', 'e', 'w'.

    Output: True if we return to starting point.
    """
    if (len(walk) == 10 and
...
if __name__ == '__main__':
    ...
    print()
    print(is_valid_walk_2(['n', 's', 'n', 's', 'n', 's', 'n', 's', 'n', 's']))
    print(is_valid_walk_2(['w', 'e', 'w', 'e', 'w', 'e', 'w', 'e', 'w', 'e', 'w', 'e']))
    print(is_valid_walk_2(['w']))
    print(is_valid_walk_2(['n', 'n', 'n', 's', 'n', 's', 'n', 's', 'n', 's']))
